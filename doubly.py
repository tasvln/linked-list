class DoublyLinked:
    ...
    class Node:
      # a node class constructor that takes in data, next and prev and sets them to the node data, next and prev respectively
      # with next and prev set to None by default
      ...
      # returns reference to previous node in DoublyLinked
    ...
    def pop_front(self):
      ...
      if self.front is None:
        ...
        if self.front is None:
          ...
          # set the front of the list prev to empty
    ...
    # this function removes the last node in the list and returns the new data stored at the back of the list
    def pop_back(self):
      ...
      # check if the list is not empty
        ...
        # set current to the back of the list
        current = self.back
        # save the data stored in the back of the list
        data = current.get_data()
        # set the back of the list to the previous node
        self.back = self.back.prev
        # if the back of the list is empty, set the front to empty
        if self.back is None:
          self.front = None
        else:
          # set the back of the list next to empty
          self.back.next = None
        # delete the current node
        del current
        # return the data stored in the back of the list
        return data
    ...
    def insert_after(self, data, node):
      ...
      # else insert node after the node passed in
        ...
        # set new node prev to the node passed in
        current.prev = node
        # set the node after the node passed in prev to the new node
